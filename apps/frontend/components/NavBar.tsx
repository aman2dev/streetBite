          ...
          <div className="relative flex items-center pl-3 border-l-2 border-on-surface">
            {user ? (
              ...
              <button
                ...
                disabled={loading}
                className="px-4 py-2 bg-white hover:bg-slate-50 text-slate-900 font-extrabold rounded-full border-2 border-on-surface shadow-[2px_2px_0px_0px_#1a1c1c] text-xs uppercase tracking-wider flex items-center gap-2 hover:-translate-y-0.5 transition-transform cursor-pointer disabled:opacity-60"
